...
```yaml
الهدف: صفحات التقييم الأسبوعي (10×5=50) والشهري (90÷3=30)
...
المتطلبات:
   ...
   ✅ صيغ الدرجات معزولة في grading-formulas.ts

المهام:
   - واجهة التقييم الأسبوعي (5 درجات × 10 أسابيع = 50 درجة)
      * جدول يعرض جميع الطالبات × جميع الأسابيع
      * درجة واحدة لكل أسبوع (5 درجات)
      * حفظ جماعي للأسبوع الحالي
   - واجهة التقييم الشهري (30 درجة × 3 مرات = 90 درجة)
      * القرآن الكريم: 15 درجة (نسيان، لحن جلي، لحن خفي)
      * التجويد النظري: 15 درجة
   - فلترة حسب الحلقة المختارة من /teacher
   - حفظ في قاعدة البيانات مع courseId
...
**APIs المطورة:** 20+ endpoint
**الصفحات:** 15+ صفحة
**Models في DB:** 8 models
