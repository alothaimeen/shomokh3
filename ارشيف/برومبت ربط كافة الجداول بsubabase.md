...
- Project URL: `postgresql://postgres.nupiaprnfcedpvoybwpt:Iloveshomokh@aws-1-us-west-1.pooler.supabase.com:6543/postgres
`
- Anon Key: `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im51cGlhcHJuZmNlZHB2b3lid3B0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg3Njk0NTIsImV4cCI6MjA3NDM0NTQ1Mn0.8R8RvRywIeze5tiavxO3vR63aptnKvQ_OgfpuGgTA8I`
- Service Role Key: `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im51cGlhcHJuZmNlZHB2b3lid3B0Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1ODc2OTQ1MiwiZXhwIjoyMDc0MzQ1NDUyfQ._uHKOfeuctjaPx_UPqAPmWFbclP4Y7CehQ3rCgIaCp8`
...
const testUsers = [
  { userEmail: "admin@shamokh.edu", userName: "الآدمن", userRole: "ADMIN" },
  { userEmail: "manager@shamokh.edu", userName: "المدير الأكاديمي", userRole: "MANAGER" },
