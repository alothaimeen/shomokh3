...
export default withAuth(
  function middleware(req) {
    ...
    const rolePermissions = {
      ADMIN: ['/dashboard', '/users', '/programs', '/students', '/attendance', '/attendance-report', '/academic-reports', '/reports', '/enrolled-students', '/teacher-requests', '/enrollment', '/my-attendance', '/my-grades', '/daily-tasks', '/daily-grades', '/profile'], // يمكنه الوصول لكل شيء
      TEACHER: ['/dashboard', '/teacher', '/programs', '/students', '/attendance', '/teacher-requests', '/enrolled-students', '/daily-grades', '/profile'], // يمكنه إدارة حلقاته وطالباته
